...
//
//   Screen_Title_Btn_Continue = lv_btn_create(Screen_Title_Page_Main, NULL);
//   //lv_obj_set_event_cb(btn1, event_handler);
//   lv_obj_align(Screen_Title_Btn_Continue, Screen_Title_Page_Main, LV_ALIGN_IN_BOTTOM_MID, 0, 15);
...
//
//   std::cout << " WROTE CONTINUE BTN " << std::endl;
//
//   //
//   //
